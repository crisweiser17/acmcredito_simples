...
class Migrator {
  public static function run(): void {
    ...
    $haveIndicador = false; $haveReferencias = false; $haveCriterios = false; $haveCadastroPublico = false; $haveDraft = false; $havePixTipo = false; $havePixChave = false;
    foreach ($cols as $col) {
      $f = ($col['Field'] ?? '');
